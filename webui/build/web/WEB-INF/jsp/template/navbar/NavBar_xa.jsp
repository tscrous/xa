                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse navbar-responsive-collapse">
                        <ul class="nav pull-right">
                            <li class="dropdown">
                                <a href="index.jsp" class="dropdown-toggle" data-toggle="dropdown">Home <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#">Default</a></li>
                                    <li><a href="#">Static Video Header</a></li>
                    ...
                    <div id="homepage">
                        ...
                        <div id="slides">
                            <div class="row">
                                <ul class="paging">
                                    <div class="slide-btn">
                                        ...
                                        <div class="span2">
                                            <li>
                                                <a class="feature-tab current" id="security" href="#4">
                                                    <i class="icon-lock"></i>
                                                </a>
                                            </li>
                                        </div>
                            ...
                            <div class="feature-content slides_container" style="overflow: hidden; position: relative; display: block;">
                                ...
                                </div><div id="security-content" class="slide-content " style="position: absolute; top: 0px; z-index: 0; display: block;">
                                    <div class="row" style="">
                                ...
                                </div><div id="roi-content" class="slide-content " style="position: absolute; top: 0px; z-index: 0; display: none;">
                                    <div class="row">
                                        <div class="span5 ">
