...
<html lang="en">
    <head>
        ...
        <title>XA - Int. Trade Advisors</title>
    ...
    <body>
        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <ul class="btn btn-navbar pull-right">
                        <li>Blah<a href="#"><i class="icon-envelope"></i></a></li>
            ...
            <div class="navbar-inner">
                <div class="container">
                    ...
                    <a href="index.html" class="brand">
                        <img id="logo" alt="maJoo" src="img/majoo.png"></a>
                    <div class="nav-collapse collapse navbar-responsive-collapse">
                        <ul class="nav pull-left">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Home <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="index-slider.html">Default</a></li>
                                    <li><a href="index-static.html">Static Video Header</a></li>
                                    <li><a href="index-version-2.html">Version 3</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="marketing.html">MARKETING PAGE</a></li>
        ...
        <div id="wrap">
            <div class="main" id="main-no-space">
                ...
                <div id="header">
                    <header style="background-image: url(http://wbpreview.com/previews/WB066736F/images/bg/darkdenim3.png);">
                        <div class="container"> 
                                ...
                                <ul class="slides">
                                    <li style="width: 100%; float: left; margin-right: -100%; position: relative; display: none;" class="">
                                        <div class="row">
                                            ...
                                            <div class="span6"><img src="images/slides/iphone.png" alt="image"></div>
                                        </div>     </li>
                                    <li style="width: 100%; float: left; margin-right: -100%; position: relative; display: list-item;" class="flex-active-slide">
                                        <div class="row">
                                            ...
                                            <div class="span6 "><img src="images/slides/draw.png" alt="image"></div> 
                                        </div>
                                    </li>
                                    <li style="width: 100%; float: left; margin-right: -100%; position: relative; display: none;" class="">
                                        <div class="row">
                                            ...
                                            <div class="span6 "><img src="images/slides/light.png" alt="image"></div>
                                        </div>
                                    </li>
                                </ul>
                ...
                <div class="content">
                    <div id="homepage">
                        ...
                        <div id="slides">
                            <div class="row">
                                <ul class="paging">
                                    <div class="slide-btn">
                                        ...
                                        <div class="span2">
                                            <li>
                                                <a class="feature-tab current" id="roi" href="#5">
                            ...
                            <div class="feature-content slides_container" style="overflow: hidden; position: relative; display: block;">
                                <div class="slides_control" style="position: relative; width: 100%; height: 285.59999999999997px;"><div id="sweepstake-content" class="slide-content" style="position: absolute; top: 0px; z-index: 0; display: none;">
                                    <div class="row">
                                        <div class="span5">
                                ...
                                </div><div id="dashboard-content" class="slide-content" style="position: absolute; top: 0px; z-index: 0; display: none;">
                                    <div class="row">
                                        <div class="span5">
                                            <img src="images/4.jpg" align="right">
                                        </div>
                                        <div class="span7">
                                ...
                                </div><div id="responsive-content" class="slide-content" style="position: absolute; top: 0px; z-index: 0; display: none;">
                                    <div class="row">
                                        <div class="span5 ">
                                            <img src="images/5.jpg" align="right">
                                        </div>
                                        <div class="span7">
                                ...
                                </div><div id="cloud-content" class="slide-content" style="position: absolute; top: 0px; z-index: 0; display: none;">
                                    <div class="row">
                                        <div class="span5 ">
                                            <br>
                                            <br>
                                ...
                                </div><div id="security-content" class="slide-content" style="position: absolute; top: 0px; z-index: 0; display: none;">
                                    <div class="row" style="">
                                ...
                                </div><div id="roi-content" class="slide-content" style="position: absolute; top: 0px; z-index: 0; display: block;">
                                    <div class="row">
                                        <div class="span5 ">
                                            <img src="images/1_1.png" align="right">
                                        </div>
                                        <div class="span7">
                    ...
                    <div id="join" class="row">
                        <div class="span8">
                            <h2>maJoo is a responsive, business website template.</h2>
                            <h4>Aliquam a nisi sed turpis ornare volutpat a nec massa. Sed sceler isque ultricies vulputate.</h4>
                        </div>
                        <div class="span3">
                            <a class="btn btn-majoo btn-large" href="#">Get Started Now!</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row" id="recent-blog">
                        <div class="span8">
                            ...
                            <div class="row">
                                <!-- Project -->
                                <div class="span2">
                                    <div class="picture"><a href="single_project.html"><img src="images/portfolio/p1.jpg" alt=""><div class="image-overlay-link" style="opacity: 0; display: block;"></div></a></div>
                                ...
                                <div class="span2">
                                    <div class="picture"><a href="images/portfolio/p2-large.jpg" rel="image" class="hoverZoomLink"><img src="images/portfolio/p2.jpg" alt=""><div class="image-overlay-zoom" style="opacity: 0; display: block;"></div></a></div>
                                    <div class="item-description">
                                ...
                                <div class="span2">
                                    <div class="picture"><a href="single_project.html"><img src="images/portfolio/p3.jpg" alt=""><div class="image-overlay-link" style="opacity: 0; display: block;"></div></a></div>
                                    <div class="item-description">
                        ...
                        <div class="span4">
                            ...
                            <div class="entry">
                                <span class="meta"><strong>10</strong><br><small>Jul.</small></span>
                                <div>
                                    <h4><a href="blog.html"><u>Latest Post 3</u></a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris molestie. <a href="blog.html">Read More</a></p>
                                </div>
...
//Slider End
        ...
        <div id="style-switcher" style="right: -260px;">
            ...
            <ul class="colors" id="color">
                ...
                <li><a href="#" class="black active" title="Black"></a></li>
            </ul>
            <h2>Slider Background</h2>
            <ul class="colors bg" id="bg">
                ...
                <li><a href="#" class="bg6 active"></a></li>
