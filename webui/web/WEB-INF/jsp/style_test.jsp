...
<div class="row-fluid">
    ...
    <div class="offset1 span10">
        <div class="offset1 options center">
            ...
            <div contenteditable="true" class="option-container">
                <div class="option-content">
                    ...
                    <div class="option-watermark"><span>1</span></div>
                    <div class="option-stats">
                        <span class="options-stats-item"><a href="#" rel="tooltip" data-placement="top" title="topic viewed 0 times"><i class="icon-search icon-white"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" data-placement="top" title="0 people found this topic useful"><i class="icon-star"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" data-placement="top" title="open cases related to this topic"><i class="icon-folder-open"></i></a></span>
                    </div>
                </div>
            </div>
            ...
            <div contenteditable="true" class="option-container">
                <div class="option-content">
                    ...
                    <div class="option-watermark"><span>2</span></div>
                    <div class="option-stats">
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip" data-original-title="topic viewed 0 times"><i class="icon-search icon-white"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip" data-original-title="0 people found this topic useful"><i class="icon-star"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip disabled" data-original-title="open cases related to this topic"><i class="icon-folder-open"></i></a></span>
                    </div>
                </div>
            </div>
            ...
            <div contenteditable="true" class="option-container">
                <div class="option-content">
                    ...
                    <div class="option-actions"><span><a href="#">TELL ME MORE <i class="icon-arrow-right icon-white"></i></a></span></div>
                    <div class="option-watermark"><span>3</span></div>
                    <div class="option-stats">
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip disabled" data-original-title="topic viewed 0 times"><i class="icon-search icon-white"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip disabled" data-original-title="0 people found this topic useful"><i class="icon-star"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip disabled" data-original-title="open cases related to this topic"><i class="icon-folder-open"></i></a></span>
                    </div>
                </div>
            </div>
            ...
            <div contenteditable="true" class="option-container">
                <div class="option-content">
                    ...
                    <div class="option-actions"><span><a href="#">TELL ME MORE <i class="icon-arrow-right icon-white"></i></a></span></div>
                    <div class="option-watermark"><span>4</span></div>
                    <div class="option-stats">
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip" data-original-title="topic viewed 0 times"><i class="icon-search icon-white"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip" data-original-title="0 people found this topic useful"><i class="icon-star"></i></a></span>
                        <span class="options-stats-item"><a href="#" rel="tooltip" class="tip" data-original-title="open cases related to this topic"><i class="icon-folder-open"></i></a></span>
                    </div>
                </div>
            </div>
