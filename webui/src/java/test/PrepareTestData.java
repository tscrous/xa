...
public class PrepareTestData {
    ...
    private void prepare(Session session) {
        ...
        CLEAR_CANVAS_PAGE = factory.createPathResource(PathResourceType.JSP, Constants.CLEAR_CANVAS_PAGE_ID, "/WEB-INF/jsp/template/page/clear_canvas_page.jsp");
    }
    ...
    private void createMenuPages(Session session) {
        ...
        homePage = factory.createPage(CLEAR_CANVAS_PAGE, Constants.HOME_PAGE_TARGET_ID, "Home", content);
        dependencyManager.setDependency(homePage, topMenu);
        /* about */
        ...
        dependencyManager.setDependency(aboutPage, topMenu);
        /* open cases */
        ...
        dependencyManager.setDependency(openCasesPage, topMenu);
        /* contact */
        ...
        dependencyManager.setDependency(contactPage, topMenu);
    }
    ...
    private void createOptionPages(Session session) {
        ...
        dependencyManager.setDependency(competitionPage, topMenu);
        /* duty increases */
        ...
        dependencyManager.setDependency(dutyIncreasePage, topMenu);
        ...
        dependencyManager.setDependency(competitivenessPage, topMenu);
        /* incentives */
        ...
        dependencyManager.setDependency(incentivesPage, topMenu);
    }
    ...
    private PathResource CLEAR_CANVAS_PAGE;
    
    private WebObjectDependencyManager dependencyManager;
